...
void Resonator::prepare(float frequency, float depth, double samplerate){
    lfo = new Sine(frequency, depth, samplerate);
}

void Resonator::setDepth(float depth){
    this->depth = depth;
}

void Resonator::processSpectrum(float* data)
{
